...
namespace Talifun.AcceptanceTestProxy.UrlRewriter.Rules.Flags
{
	...
	{
        private static readonly ILog Logger = LogManager.GetLogger(typeof(SkipRuleFlag));

		/// <summary>
		/// Initializes a new instance of the <see cref="SkipRuleFlag"/> class.
		/// </summary>
		/// <param name="count">The index.</param>
		...
		public RuleFlagProcessorResponse Apply(RuleContext context)
		{
            ...
            Logger.InfoFormat("Skip The Next + {0} To Rule {1}", Count, context.RuleIndex);
